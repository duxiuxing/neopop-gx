...
TARGET		:=	neopop
BUILD		:=	build
SOURCES		:=	source/Core/TLCS-900h source/Core/z80 source \
			source/System_NGC source/System_NGC/gui source/Core 
INCLUDES	:=	source/Core/TLCS-900h source/Core/z80 source \
			source/System_NGC source/System_NGC/gui source/Core 

#---------------------------------------------------------------------------------
# options for code generation
#---------------------------------------------------------------------------------
MACHDEP	= -DGEKKO -mcpu=750 -meabi -mhard-float -DNGC
CFLAGS  = -g -O2 -Wall $(MACHDEP) $(INCLUDE) -DMSB_FIRST="1" -DNGC="1" \
	  -fno-strict-aliasing
