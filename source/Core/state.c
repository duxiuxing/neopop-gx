...
#ifdef NGC
#include <zlib.h>
extern unsigned char savebuffer[0x10000];
#endif

//=============================================================================

void read_state_0050(char* filename);
...
int state_store(char* filename)
{
	...
	return 1;
#else
	/* modified for zipped savestates */
	//memcpy(&savebuffer, &state, sizeof(NEOPOPSTATE0050));
...
#else
	/* modified for zipped savestates */
	//memcpy(&state, &savebuffer, sizeof(NEOPOPSTATE0050));
